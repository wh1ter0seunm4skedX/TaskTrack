            ...
            <div className="fixed top-4 left-4 z-50">
                <label htmlFor="language-toggle" className="flex items-center cursor-pointer">
                    <div className="relative">
                        <input type="checkbox" id="language-toggle" className="checkbox hidden" onChange={toggleLanguage}/>
                        <div className="block border-[1px] dark:border-white border-gray-900 w-14 h-8 rounded-full"></div>
                        <div className="dot absolute left-1 top-1 dark:bg-white bg-gray-800 w-6 h-6 rounded-full transition transform translate-x-0 checked:translate-x-full"></div>
                    </div>
